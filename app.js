class ChatApp {
    ...
    translateUI() {
        ...
        if (updateTitle) {
            updateTitle.textContent = t.updateLog + ' v4.4.3';
        }
        ...
        // 页脚
        document.querySelector('.footer-info p:first-child').textContent = 'Tell v4.4.3';
        document.querySelector('.copyright').textContent = t.copyright;

        // 版本信息
        document.querySelector('.version-info span:first-child').textContent = 'v4.4.3';
